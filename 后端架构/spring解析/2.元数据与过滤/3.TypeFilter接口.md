...
<img src="img/image-20241106151455549.png" alt="image-20241106151455549" style="zoom:50%;" />
...
MyAnnotation注解被用作 TypeFilter 中的匹配条件，用于过滤带有此注解的类。
...
#### 7.1 ClassPathScanningCandidateComponentProvider
