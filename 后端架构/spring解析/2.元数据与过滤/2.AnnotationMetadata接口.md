...
通过 `getMethodMetadata()`、`getFieldMetadata()` 和 `getClassMetadata()` 方法，可以获取类中方法、字段和类本身的元数据信息，以便分析这些元素上的注解。
...
<img src="img/image-20241106131052129.png" alt="image-20241106131052129" style="zoom:50%;" />
